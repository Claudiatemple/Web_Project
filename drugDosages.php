<?php
//Below is the connection of different pages
...
if (isset($_POST["Save_Dosage_Record"])) {
    ...
    if ($stmt = $con->prepare($query)) {
        ...
        if ($stmt->execute()) {
            ...
            echo '<h4 class="text-danger text-center">Check Error! Saving Dosage in the system</h4>';
        }
    }else{
        echo '<h4 class="text-danger text-center">Check Error! Something went wrong</h4>';
    }
}


?>
<?php set_header("New Drug") ?>

<div class="contianer">
    <div class="row mt-2">
        <div class="col-md-4 p-5">
            <h4 class="display-4">Display Drug Record</h4>
